...
const handleFormSubmit = async (formData: FormData) => {
    ...
    try {
      ...
      void formData; // form data will be forwarded in future implementation
...
<div className="flex items-center gap-2">
      ...
      <section className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto px-4 mb-8 text-center">
